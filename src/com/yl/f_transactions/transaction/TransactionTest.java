package com.yl.f_transactions.transaction;
 ...
 * 
 * 4.哪些操作会导致数据的自动提交？
 * 		>DDL操作一旦执行，都会自动提交。create/drop table/index; alter table
 * 			>set autocommit = false 对DDL操作无效
 * 		>DML默认情况下，一旦执行，就会自动提交。insert/update/delete
 * 			>我们可以通过set autocommit = false的方式取消DML操作的自动提交。
 * 		>默认在关闭连接时，会自动的提交数据
 * 		>DCL 操作， grant/revoke/commit/rollback/lock
 */
public class TransactionTest {
	...
	// Connection作为参数传入，而不是在方法里面直接获取，否则执行一次方法就会开启一次事务
